  ...
  return (
    ...
    <form className="flex flex-wrap w-full items-start justify-between">
     ...
     <div>
      ...
      <input  className="text-sm py-1  px-2 w-4/5  rounded outline-none  bg-transparent  border-[1px] border-gray-400 mb-4 "  type="text" placeholder="Employee" />
       </div>
       <div>
          <h3 className=" text-sm  text-gray-300  mb-0.5">Category</h3>
      <input  className="text-sm py-1  px-2 w-4/5  rounded outline-none  bg-transparent  border-[1px] border-gray-400 mb-4 "  type="text" placeholder="Design, Development, etc..."/>
       </div>
     </div>
